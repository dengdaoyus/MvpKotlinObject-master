...
import com.example.tasks.TasksContract
import com.example.tasks.TasksFilterType
import com.example.tasks.TasksPresenter
...
class TasksPresenterTest {
     ...
     */
    @Captor private lateinit var loadTasksCallbackCaptor: ArgumentCaptor<TasksDataSource.LoadTasksCallback>
